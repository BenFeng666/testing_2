"""
Evaluate the (fine-tuned or base) ChemLLM-7B model on test data
"""
        ...
        for _, row in df.iterrows():
            ...
            data.append({
                "messages": [
                    ...
                    {
                        "role": "user",
                        "content": f"What is the predicted transfection efficiency for this molecular structure: {structure}?"
                    },
                    {
                        "role": "assistant",
                        "content": f"The predicted transfection efficiency for the molecular structure {structure} is {score}."
                    }
                ]
            })
        return data
...
if __name__ == "__main__":
    # Run without LoRA for baseline
    evaluate_model(
        model_path=None,  # 👈 Leave as None to run baseline
        base_model_name="AI4Chem/ChemLLM-7B-Chat",
        test_data_path="/content/testing_2/dataset/testing.xlsx"
    )
