...
def evaluate_model(
    ...
    print(f"\n{'='*60}")
    print(f"EVALUATION RESULTS - Qwen2-7B Model")
    print(f"{'='*60}")
    ...
    results_file = f'{output_path}/evaluation_results_7b.json'
...
if __name__ == "__main__":
    # Evaluate the Qwen2-7B model
    results = evaluate_model(
        model_path="../checkpoints/qwen_lora_finetuned",
        base_model_name="Qwen/Qwen2-7B-Instruct",
        test_data_path="../../../data/test_data.jsonl"
    )
